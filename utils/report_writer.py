...
#     english = student_data["English Score"]
#     science = student_data["Science Score"]
...
#     filename = f"{student_data['Student Name'].replace(' ', '_')}_report.pdf"
#     filepath = os.path.join(output_dir, filename)
...
#     pdf.cell(200, 10, txt=f"Name: {student_data['Student Name']}", ln=True)
#     pdf.cell(200, 10, txt=f"Email: {student_data['Email ID']}", ln=True)
#     pdf.cell(200, 10, txt=f"Math Score: {student_data['Math Score']}/100", ln=True)
#     pdf.cell(200, 10, txt=f"English Score: {student_data['English Score']}/100", ln=True)
#     pdf.cell(200, 10, txt=f"Science Score: {student_data['Science Score']}/100", ln=True)
#     pdf.ln(10)
